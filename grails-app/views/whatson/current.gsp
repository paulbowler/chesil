<html>
    <head>
        ...
        <title>Current Productions - Chesil Theatre</title>
    ...
    <body>
		<div id="topsection">
			...
			<div id="menu">
				<ul>
					<li>&nbsp;</li>
					<li><a class="active" href="/whatson/current">current</a></li>
					<li><a href="/whatson/archive">archive</a></li>
				</ul>
			</div>
			<div id="mainmenu">
				<a href="/whatson"><img src="/img/whatson_on.png" alt="Whats on"/></a>
		...
		<div id="contentwrapper">
			<div id="contentcolumn">
				<div class="innertube">
					<g:each in="${content.channel.item}" var="play">
						${play.group.description}
						<hr/>
					</g:each>
				</div>
			</div>
		...
		<div id="rightcolumn">
			<div class="innertube">
				<div id="sliderholder">
					<div id="slider"><img src="${content.channel.item[0].group.content.@url}" alt="Current Productions"/></div>
				</div>
			</div>
			<div class="innertube">
