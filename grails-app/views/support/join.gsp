<html>
    <head>
        ...
        <title>Join Us - Chesil Theatre</title>
    ...
    <body>
    	<div id="topsection">
			...
			<div id="menu">
				<ul style="margin-left: 240px;">
					<li><a class="active" href="/support/join">join us</a></li>
		...
		<div id="rightcolumn">
			<div class="innertube">
				<div id="sliderholder">
					<div id="slider"><img src="${content.channel.item[0].group.content.@url}" alt="Join Us"/></div>
				</div>
			</div>
			<div class="innertube">
