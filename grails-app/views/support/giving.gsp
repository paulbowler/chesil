<html>
    <head>
        ...
        <title>Giving - Chesil Theatre</title>
    ...
    <body>
    	<div id="topsection">
			...
			<div id="menu">
				<ul style="margin-left: 240px;">
					...
					<li><a class="active" href="/support/giving">giving</a></li>
				</ul>
			</div>
			<div id="mainmenu">
		...
		<div id="rightcolumn">
			<div class="innertube">
				<div id="sliderholder">
					<div id="slider"><img src="${content.channel.item[0].group.content.@url}" alt="Theatre Giving"/></div>
				</div>
			</div>
			<div class="innertube">
