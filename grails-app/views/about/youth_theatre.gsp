<html>
    <head>
        ...
        <title>Youth Theatre - Chesil Theatre</title>
    ...
    <body>
    	<div id="topsection">
			...
			<div id="menu">
				<ul style="margin-left: 125px;">
					...
					<li><a class="active" href="/about/youth_theatre">youth theatre</a></li>
				</ul>
			</div>
			<div id="mainmenu">
		...
		<div id="rightcolumn">
			<div class="innertube">
				<div id="sliderholder">
					<div id="slider"><img src="${content.channel.item[0].group.content.@url}" alt="Youth Theatre"/></div>
				</div>
			</div>
			<div class="innertube">
