<html>
    <head>
        ...
        <title>Taking part in the Theatre - Chesil Theatre</title>
    ...
    <body>
    	<div id="topsection">
			...
			<div id="menu">
				<ul style="margin-left: 125px;">
					<li><a href="/about/theatre">our theatre</a></li>
					<li><a class="active" href="/about/taking_part">taking part</a></li>
		...
		<div id="rightcolumn">
			<div class="innertube">
				<div id="sliderholder">
					<div id="slider"><img src="${content.channel.item[0].group.content.@url}" alt="Taking Part"/></div>
				</div>
			</div>
			<div class="innertube">
